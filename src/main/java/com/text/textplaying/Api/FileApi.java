...
public class FileApi {
	...
	public String inserttext(@RequestHeader(value = "Authorization") String UserPass, @PathVariable String Filename,
			@RequestBody String TxtValue) {
		return this.textService.inserttext(UserPass, Filename, TxtValue);
	}

	@PostMapping("/text/update/{Filename}")
	public String update(@RequestHeader(value = "Authorization") String user, @PathVariable String Filename,
